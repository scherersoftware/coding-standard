...
class LenientControlSignatureSniff implements \PHP_CodeSniffer_Sniff
{

	/** @var bool */
	public $treatColonLikeOpeningBrackets = false;
    ...
    public function process(\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
		...
		if ($tokens[$stackPtr]['code'] === T_ELSE
			&& $this->treatColonLikeOpeningBrackets === false
        ...
        if (isset($tokens[$stackPtr]['parenthesis_closer']) === true
			...
			if ($this->treatColonLikeOpeningBrackets === false
				&& $phpcsFile->getTokensAsString(($closer + 1), ($opener - $closer)) === ':'
			) {
				return;
			}
